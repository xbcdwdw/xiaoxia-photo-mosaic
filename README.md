# 📸 小夏同学照片拼图器 (Photo Mosaic)

> 一款完全本地计算的跨平台照片拼图工具，专为 6 寸照片打印机（148×100mm）设计。
> 实验对象：**小米米家桌面照片打印机 1S / 2**。

## 🎯 项目背景

最初是为**微信小程序**设计的照片拼图工具，但在小程序审核过程中遇到严重问题：

1. **图片审核机制**：所有本地图片上传都需要经过微信的图片安全审核，处理速度极慢
2. **功能限制**：小程序对本地图片处理能力有限，无法支持高分辨率输出
3. **审核反复被拒**：涉及图片处理功能的小程序审核门槛高，上线困难
...
- ✅ **跨平台** — Windows 桌面版 + Android 移动版

## 🖨 适配打印机

| 打印机 | 说明 |
|--------|------|
| **小米米家桌面照片打印机 1S** | 6 寸相纸（148×100mm），基本兼容 |
...
### 直接安装
从 [Releases](https://github.com/xbcdwdw/photo-mosaic/releases) 页面下载最新 APK，传到手机上安装即可。
